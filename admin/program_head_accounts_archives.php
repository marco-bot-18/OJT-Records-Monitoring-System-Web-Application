            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="program_head_accounts_archives.php">Program Head Accounts</a>
                    </div>
                </div>  
            </li>
...
<!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><span><b>Archives</b> / Program Head Accounts</h1>
    </div>
...
<style>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3" style="color: #333333; background: white;">
            The use of this application is intended only to view or retrieve an account of program heads.<br><br>
        </div>
        <div class="card-header py-3" style="background: #595959;">
            <h6 class="m-0 font-weight-bold" style="color: ghostwhite;">
                <i class="fas fa-user-tie"></i> Archived User Account of Program Heads
            </h6>
        </div>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content" style="color: #333333;">
                              ...
                              <div class="modal-body">
                                <form action="program_head_account_retrieve.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="course" id="course">
                                            ...
                                            include 'includes/db_connect_pdo.php';
                                            //using pdo format
                                            $sql1 = "SELECT DISTINCT course_code from tbl_courses";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="acad_yr_sem" id="acad_yr_sem">
                                            ...
                                            //using pdo format
                                            $active = "active";
                                            $sql2 = "SELECT * from tbl_academic_year_sem WHERE status=:active";
                                            $query2 = $dbh -> prepare($sql2);
                                            $query2->bindParam(':active',$active,PDO::PARAM_STR);
                                            $query2->execute();
                                            $results2=$query2->fetchAll(PDO::FETCH_OBJ);
                                            $cnt=1;
                                            if($query2->rowCount() > 0) {
                                                foreach($results2 as $result2){?>
                                                <option value="<?php echo $result2->academic_yr." - ".$result2->semester; ?>">
                                                    <?php echo $result2->academic_yr." - ".$result2->semester;?>
                                                </option>
                                            <?php }} ?>
                                        </select>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#acad_yr_sem").on('change', function(){
            var value = $(this).val();
            $.ajax({
                url:"program_head_accounts_archives_fetch.php",
                type:"POST",
                data: 'request2=' + value,
                beforeSend:function(){
    ...
    if (isset($_SESSION['retrieved'])) {?>
        <script>
            swal.fire({
             icon: 'success',
             type : 'success',
             title : 'Program Head Account was Retrieved Successfully!',
