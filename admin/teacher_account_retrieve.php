...
if (isset($_POST['retrieve'])) {
    if($my_password == $correct_password){
        ...
        if($query_run){
            $active = "active";
            $session_log = "You retrieved the OJT teacher user account of <b>".$full_name_and_id."</b>";
            ...
            if($query_log_run){
                ...
                $session_audit =  $get_name_id." retrieved the OJT teacher user account of <b>".$full_name_and_id."</b>";
                ...
                if($query_audit_run){
                    ...
                    header('location: teacher_accounts_archives.php');
                }
            }
        }
    }
