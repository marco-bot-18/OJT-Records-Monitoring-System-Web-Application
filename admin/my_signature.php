                        ...
                        <div class="form-group">
                            <div id="dvSign" style="display: none;">
                                <a style="text-decoration: none; color: ghostwhite;" href="" data-toggle="modal" data-target="#upload_new_signature">
                                    <div class="image">
                                    <?php //calling the signature of dean
                                        $userType = "Dean";
                                        $ses_sql = mysqli_query($conn,"SELECT * FROM tbl_signature where owner_signature='$userType'");
                                        $row = mysqli_fetch_array($ses_sql,MYSQLI_ASSOC);
                                        $_SESSION['my_signature'] = $row['image'];
                                    ?>
                                    <img src="uploaded_signature_imgs/<?php echo $_SESSION['my_signature']; ?>" class="rounded" alt="" id="image1" width="300px;" height="300px" style="border: 1px solid gray">
