            ...
            <li class="nav-item active">
                ...
                <div id="collapseTeacherList" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="coordinators_list_active.php">Active</a>
...
<!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><b>Teachers</b> / Active</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-dark">
                ...
                <a href="coordinators_list_active.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm active">Active <i class="fas fa-stream"></i></a>
                <a href="coordinators_list_notActive.php" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">Not Active <i class="fas fa-ellipsis-h"></i></a>
            </h6>
        </div>
            <!-- table -->
            <div class="card-body">
                    ...
                    <table class="table table-hover" id="dataTable"  cellpadding="20"  id="example" width="100%" style="color:  #333333;">
                      ...
                      <tbody>
                        <?php
                            ...
                            $isArchived = "not archived";
                            $usertype = "teacher";
                            $sql = "SELECT * FROM tbl_coordinators where isArchived='$isArchived' and status='$stats' and userType='$usertype' ORDER BY id ASC";
                            $query = $conn->query($sql);
