...
<!-- Page Heading -->
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="request_docs_completed.php" class="btn btn-sm btn-success shadow-sm" title="Approved Documents"><i class="fas fa-check-circle"></i> Signed as Completed 
                <span class="badge badge bg-danger" style="color: white;">
                    <?php
                        $work_stats1 = "completed";
                        $send_to_dean = "dean";
        ...
        <?php ?>
            <h6 class="m-0 font-weight-bold text-primary">
                Pending Documents Forwarded by Program Head. All the documents here are need of approval and signature. Click the insert signature button on the left to sign the document automatically. Once the document is signed, you can be able to set the student's requirement in completed status.
            </h6>
        </div>
        <div class="card-header py-3" style="background: #595959;">
            <h6 class="m-0 font-weight-bold" style="color: ghostwhite;">
                <i class="fas fa-file-alt"></i> Pending Documents 
            </h6>
        </div>
        <div class="card-body">
                ...
                <table  class="table table-hover" id="dataTable" width="100%" cellspacing="10"  id="example" style="color: #333333;">
                  ...
                  <?php
                    ...
                    <tr id="tra">
                      ...
                      <td width="20%">
                          <div>
                            <i class="fas fa-user-graduate" style="color: #dc3545;"></i> <?php echo $row['stud_name_and_id']; ?>
                        </div>
                        <div>
                      ...
                      <td width="20%"><b><a href="../program_head/signed_docs/<?php echo $row['uploaded_file'];?>" target="_blank" title="Download File"><i class="fas fa-file"></i> <?php echo $row['uploaded_file'];?></a> </b> </td>
                      ...
                      <td width="10%">
                          ...
                          <a href="#forward<?php echo $id;?>" title="Set as Completed" data-toggle="modal" ><button class="btn btn-success"><i class="fas fa-check-square"></i></button></a>

                          <a href="request_docs_insert_signature.php?file_id=<?php echo $id;?>" class="btn btn-info" title="Insert Signature"><i class="fas fa-signature"></i></a>

                          <!-- <form action="" method="POST">
                            <input type="text" name="file_name" value="">
                            <button type="submit" name="insert_signature" class="btn btn-primary">Create Your Signature On The File <i class="fas fa-signature"></i></button>
                          </form> -->
                          ...
                          <div class="modal-dialog modal-lg" role="document" style="color:  #333333;">
                            <div class="modal-content modal-lg">
                              <div class="modal-header modal-lg">
                                <h5 class="modal-title" id="exampleModalLabel"><h style="color: #0d6efd"><i class="fas fa-file-alt"></i> <?php echo $row['title']; ?> / Set As Completed </h><span><?php //echo $row['edited']; ?></span></h5>
                              ...
                              <div class="modal-header modal-lg">
                                ...
                                <h title="Date and Time Forwarded"><i style="color: #1a8cff;" class="fas fa-clock"></i> <?php  echo $row['dean_forward_date']; ?></h> • <h title="Forwarded and Approved By"><i class="fas fa-user-check" style="color: #1a8cff;"></i> <?php echo $row['name_of_program_head']?></h></p> 
                              </div>
    ...
    if (isset($_SESSION['set_as_completed'])) {?>
        <script>
            swal.fire({
             icon: 'success',
             type : 'success',
             title : 'Student Requirement is Now in Completed Status!',
