...
<!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><span><b>Teachers </b></span></h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3" style="background: #595959;">
            <h6 class="m-0 font-weight-bold" style="color: ghostwhite;">
                <i class="fas fa-user-tie"></i> List of OJT Teachers : 
                <?php
                    $usertype = "teacher";
                    $isArchived = "not archived";
                    $sql = "SELECT * FROM tbl_coordinators WHERE isArchived='$isArchived'";
                    $query = $conn->query($sql);
                    echo $query->num_rows;
                ?>
            </h6>
                          ...
                          <div class="modal-dialog modal-lg" role="document" style="color:  #333333;">
                            <div class="modal-content modal-lg">
                              <div class="modal-header modal-lg">
                                <h5 class="modal-title" id="exampleModalLabel" style="color: #0d6efd;"><h><i class="fas fa-user-tie"></i> View OJT Teacher's Details</h5>
