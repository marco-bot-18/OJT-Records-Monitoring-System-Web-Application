            ...
            <li class="nav-item active">
                ...
                <div id="collapseStudList" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="students_list_active.php">Active</a>
...
<!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><span><b>Students</b> / Active</span></h1>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3" style="background: #595959;">
            <h6 class="m-0 font-weight-bold" style="color: ghostwhite;"> 
                List of Students / Active: <?php
                    $active = "active";
                    $isArchived = "not archive";
                    $sql = "SELECT * FROM tbl_students where status='$active' and archived='$isArchived'";
                    $query = $conn->query($sql);
                    echo $query->num_rows;
                ?>
            </h6>
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-dark">
                ...
                <a href="students_list_active.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm active">Active <i class="fas fa-stream"></i></a>
                <a href="students_list_notActive.php" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">Not Active <i class="fas fa-ellipsis-h"></i></a>
            </h6>
        </div>
        <div class="card-header py-2">
            <div class="form-group">
                <select class="form-control form-control-sm" id="fetchval2" name="acad_yr_sem" style="width: 700px; color: #333333;">
                    <?php
                    ...
                    <table class="table table-hover" id="dataTable"  cellpadding="20"  id="example" width="100%" style="color: #333333;">
                      ...
                      <tbody>
                        <?php
                            ...
                            $stats = "active";
                            $isArchived = "not archive";
                            $sql = "SELECT * FROM tbl_students where status='$stats' and archived='$isArchived' ORDER BY id ASC";
                            $query = $conn->query($sql);
