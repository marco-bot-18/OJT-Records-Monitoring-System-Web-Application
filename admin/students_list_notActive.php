...
<!-- ayusin ang design tas maggawa na ng SRS, TAM. -->
<?php
session_start();
            ...
            <li class="nav-item active">
                ...
                <div id="collapseStudList" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="students_list_notActive.php">Not Active</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTeacherList" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="coordinators_list_notActive.php">Not Active</a>
                    </div>
                </div>
            </li>
...
<!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><span><b>Students</b> / Not Active</span></h1>
    ...
    <div class="card shadow mb-4">
        <!-- <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <h6 class="m-0 font-weight-bold text-primary">
                    Total Students (Not Active) :
                    <?php
                        $not_active = "not active";
                        $sql = "SELECT * FROM tbl_students where status='$not_active'";
                        $query = $conn->query($sql);
                        echo $query->num_rows;
                    ?>
                </h6>
        ...
        <div class="card-header py-3" style="background: #595959;">
            <h6 class="m-0 font-weight-bold" style="color: ghostwhite;"> 
                List of Students / Not Active : 
                <?php
                    $isArchived = "not archive";
                    $not_active = "not active";
                    $sql = "SELECT * FROM tbl_students where status='$not_active' and archived='$isArchived'";
                    $query = $conn->query($sql);
                    echo $query->num_rows;
                ?>
            </h6>
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-dark">
                <a href="students_list_all.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">All <i class="fas fa-list"></i> </a>

                <a href="students_list_active.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">Active <i class="fas fa-stream"></i></a>
                <a href="students_list_notActive.php" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm active">Not Active <i class="fas fa-ellipsis-h"></i></a>
            </h6>
        </div>
        <div class="card-header py-2">
            <div class="form-group">
                <select class="form-control form-control-sm" id="fetchval3" name="acad_yr_sem" style="width: 700; color: #333333;">
                    <?php
                    ...
                    <table class="table table-hover" id="dataTable"  cellpadding="20"  id="example" width="100%" style="color: #333333;">
                      ...
                      <tbody>
                        <?php
                            ...
                            $stats = "not active";
                            $sql = "SELECT * FROM tbl_students where status='$stats' ORDER BY id ASC";
                            $query = $conn->query($sql);
