            ...
            <li class="nav-item active">
                ...
                <div id="collapseAnnouncements" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="announcement_for_today.php">Today
...
<!-- Page Heading -->
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><span><B>Announcements</B> / Today </span></h1>
    </div>

    <!-- Show Table Area -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
             <a href="announcement_history.php" class="btn btn-sm btn-primary shadow-sm" title="Click Here To See All The Announcements"><i class="fas fa-reply-all"></i> All
                <span class="badge bg-danger" style="color: white;">
                    <?php
                        $receiver_name = $_SESSION['student_fullname_session']; //receiver name get from includes/session.php
                        $posted_by1 = "Dean";
             ...
             <a href="announcement_for_today.php" class="btn btn-sm btn-warning shadow-sm active" title="Click Here To See The New Announcements for Today"><i class="fas fa-calendar-day"></i> Today
                <span class="badge bg-danger" style="color: white;">
                    <?php
                        date_default_timezone_set('Asia/Manila');
                        $td = date("F d, Y");
        ...
        <div class="card-header py-3" style="background: #595959;">
            <h6 class="m-0 font-weight-bold" style="color: ghostwhite;">
               <i class="fas fa-calendar-day"></i> Announcements for Today (<?php date_default_timezone_set('Asia/Manila');
            ...
            <div class="table-responsive">
                <table class="table" width="100%" cellspacing="10"  id="example1" style="color: #333333;">
                  ...
                  <?php
                    ...
                    $stats = "not archived";
                    $count = 1;
                    $sql = "SELECT * FROM tbl_announcement_receiver WHERE (posted_by='$posted_by1' and status='$stats' and date_='$td' and publish_status='$pub_stats' and receiver_name='$receiver_name' and sendTo='$sendTo') 
                    OR 
                    (posted_by='$posted_by2' and date_='$td'  and status='$stats' and publish_status='$pub_stats' and receiver_name='$receiver_name' and sendTo='$sendTo') 
                    OR 
