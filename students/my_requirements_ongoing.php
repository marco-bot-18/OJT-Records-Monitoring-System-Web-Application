...
<!-- Page Heading -->
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><span><b>My Requirements</b> / Submitted / Pending </span></h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="my_requirements_completed.php" class="btn btn-sm btn-success shadow-sm" title="Completed Requirements"><i class="fas fa-clipboard-check"></i> Completed Requirements
            ...
            <a href="my_requirements_ongoing.php" class="btn btn-sm btn-warning shadow-sm active" title="Pending Requirements"><i class="fas fa-file-alt"></i> Pending Requirements 
                <span class="badge bg-danger">
                    <?php
                        $student_teacher = $_SESSION['student_teacher'];
                        $work_stats = "semi-pending";
        ...
        <!-- <div class="card-header py-3">
                ...
                <h>List of Your Submitted Requirements (Make sure that your OJT teacher's remarks are approved and comments are good. Make sure that the status is "<h style='color: green;'>COMPLETED</h>").</h><br><br>
            </h6>
        </div> -->
        <div class="card-header py-3" style="background: #595959;">
            <h6 class="m-0 font-weight-bold" style="color: ghostwhite;">
              <i class="fas fa-file-alt"></i> List of Your Submitted Requirements (Pending Status)
            </h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-hover"  width="100%" cellspacing="10"  id="example1" style="color: #333333;">
                  ...
                  <?php
                    ...
                    <tr id="tra">
                      ...
                      <td><b><a href="upload_docs/<?php echo $row['uploaded_file'];?>" target="_blank" title="Download File"><i class="fa fa-file"></i><?php echo $row['uploaded_file'];?></a> </b> </td>
                      ...
                      <td>
                          <a href="#view<?php echo $id;?>" data-toggle="modal" ><button class="btn btn-primary"><i class="fas fa-check-square" title="Want to Submit? Click Here!"></i></button></a>
                      </td>
                            ...
                            <div class="modal-content modal-lg">
                              ...
                              <div class="modal-header modal-lg">
                                <p class="modal-title" id="exampleModalLabel">
                                    <h title="Date and Time Submitted">
                                    <i style="color: #1a8cff;" class="fas fa-clock"></i>
                                    <?php $date_time_posted = $_SESSION['datetime2']; echo $date_time_posted; ?></h></p> 
                              </div>
                              ...
                              <input type="text" class="form-control" name="title" value="<?php echo $row['title'];?>" hidden>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md"> -->
                                                <div class="form-group">
                                                    ...
                                                    <?php if($row['sample_file'] != ""){?><b><a href="../admin/upload_docs/<?php echo $row['sample_file'];?>" target="_blank" title="Download File"><?php echo $row['sample_file'];?></a> </b><?php } else { echo "<b style='color: red;'>There's No Attached File</b>"; } ?>
                                                </div>
                                                <hr>
                                                ...
                                                <?php 
                                                    ...
                                                    $sql1 = "SELECT Concat(date_submitted,' at ',time_submitted) AS dateTTime1 FROM tbl_students_work where id='$task_id'";
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <b><a href="upload_docs/<?php echo $row['uploaded_file'];?>" target="_blank" title="Download File"><i class="fa fa-file"></i><?php echo $row['uploaded_file'];?></a></b>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="4" readonly="" style="background: ghostwhite;" id="teacher_comment" name="comment" class="form-control"><?php echo $row['comment'];?></textarea>
                                                </div>
                                            <!-- </div>
                                            <div class="col-md"> -->
                                                <?php if ($row['work_status']=="semi-pending" && $row['remarks']=="Not Approved") {
                                                ?>
                                                 <div class="form-group">
                                                    <label>Re-Attached Your Work Here:</label> <br>
                                                    <input type="file" class="form-control" accept="application/pdf"  id="my_file" name="my_file" required="">
                                                  
                                                </div>

                                                <?php } 
                                                    else if ($row['work_status']=="semi-pending" && $row['remarks']=="Approved"){ echo "";?>

                                                <?php } else if ($row['work_status']=="semi-pending" && $row['remarks']=="waiting") {?>
                                                    <div class="form-group">
                                                        <label>Re-Attach Your Work Here: </label><font style="color: red;"> <!-- (Accepts only a pdf file format) --> </font> <br>
                                                        <input type="file" accept="application/pdf" class="form-control" name="my_file" id="my_file" required="">
                                                    </div>
                                                <?php } ?>

                                                <div class="form-group">
                                                    <label>Your Comment: </label>
                                                    <textarea rows="5" style="background: white; " name="student_comment" class="form-control" placeholder="Add Your Comments Here. . . "  id="student_comment" aria-describedby=""><?php echo $row['student_comment'];?></textarea>
                                                </div>
                                                <hr>
                                                <div class="form-group">
                                                </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <?php if ($row['work_status']=="semi-pending" && $row['remarks']=="Not Approved") { ?>
                                     <button type="submit" name="resubmit" class="btn btn-primary">Re-Submit <i class="fas fa-check-square"></i></button>

                                     <?php } 
                                        else if ($row['work_status']=="semi-pending2" && $row['remarks']=="Approved"){?>

                                        <button type="submit" name="comment" class="btn btn-primary">Update Your Comment <i class="fas fa-comments"></i></button>
...
<?php
    if (isset($_SESSION['resubmitted'])) {?>
        <script>
            swal.fire({
             icon: 'success',
             type : 'success',
             title : 'You Resubmitted the Requirement Successfully.',
             text : '<?php echo $_SESSION['resubmitted']?>'
         })
        </script>
    <?php unset($_SESSION['resubmitted']);
    }
?>
<?php
    if (isset($_SESSION['comment'])) {?>
        <script>
            swal.fire({
             icon: 'success',
             type : 'success',
             title : 'You Commented in Your Approved Requirement.',
             text : '<?php echo $_SESSION['comment']?>'
         })
        </script>
...
$('.published').on('click',function(e){
 ...
 if(flashdata5){
     swal.fire({
         icon: 'success',
         type : 'success',
         title : 'Comment to Your Approved Requirement',
         text : 'Your comment was updated!'
     })
 }
</script>
