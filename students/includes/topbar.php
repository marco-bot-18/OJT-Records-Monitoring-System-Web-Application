            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- <form
                        ...
                        <br>
                        <div class="">
                            <div title="My OJT Info">
                              <b><i class="fas fa-id-badge" title="OJT Teacher Name" style="color: #dc3545;"></i> &nbsp; <?php echo "".$_SESSION['student_fname']." ".$_SESSION['student_mname']. " ".$_SESSION['student_lname']; ?> (<?php echo $_SESSION['student_id'];?>) </b> <i class="fas fa-university" title="Course/Program" style="color: #dc3545;"></i>
                              <?php echo "<b>".$_SESSION['student_course']."</b>";?> <i class="fas fa-chalkboard-teacher" title="My OJT Teacher" style="color: #dc3545;"></i>&nbsp;&nbsp;
                              <?php echo "<b>".$_SESSION['student_teacher']."</b>";?>
                            </div>
                            <br>
                       ...
                       <!-- Nav Item - Alerts -->
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * from tbl_students_work where stud_name_and_id=:stud_name_id and isReadStud1=:isread and work_status=:completed";
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <h6 class="dropdown-header">
                                    Completed Requirements Notification
                                </h6>
                                <?php 
                                    $isread=0;
                                    $sql = "SELECT * from tbl_students_work where stud_name_and_id=:stud_name_id and isReadStud1=:isread and work_status=:completed";
                                ...
                                $query->bindParam(':completed',$completed,PDO::PARAM_STR);
                                    ...
                                    if($query->rowCount() > 0) {
                                        ...
                                        { ?> 
                                <a class="dropdown-item d-flex align-items-center" href="my_requirements_completed_details.php?req_id=<?php echo htmlentities($result->id);?>">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        ...
                                        <b>A requirement has been in completed status! </b> <br>
                                ...
                                <?php } ?>
                                <form action="my_requirements_completed.php" method="POST" enctype="multipart/form-data">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <?php
                                ...
                                $isread=0;
                                $stud_name_id = $_SESSION['stud_fullname'];
                                $sql = "SELECT * from tbl_students_work where stud_name_and_id=:stud_name_id and isReadStud=:isread";
                                $query = $dbh -> prepare($sql);
                                $query->bindParam(':stud_name_id',$stud_name_id,PDO::PARAM_STR);
                                $query->bindParam(':isread',$isread,PDO::PARAM_STR);
                                $query->execute();
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <?php 
                                    ...
                                    if($query->rowCount() > 0) {
                                        foreach($results as $result)
                                        { ?> 
                                <a class="dropdown-item d-flex align-items-center" href="my_requirements_pending_details.php?req_id=<?php echo htmlentities($result->id); ?>">
                                    <div class="mr-3">
                                        <div class="icon-circle bg-success">
                                            <i class="fas fa-tasks" style="color: white;"></i>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <b>A new requirement has been given by your teacher! </b> <br>
                                        <?php echo htmlentities($result->title);?>
                                    </div>
                                </a>
                                <?php }} else { ?>
                                ...
                                <?php } ?>
                                <form action="my_requirements_pending.php" method="POST" enctype="multipart/form-data">
                                <button style="outline: none;" class="dropdown-item text-center small text-gray-500" href="" name="read_all">Mark All as Read</button>
                                <input type="text" name="read_all_notifs" hidden="" value="read all">
                                </form>
                            </div>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" id="messagesDropdown" role="button"
                                ...
                                $isread=0;
                                $stud_name_id = $_SESSION['stud_fullname'];
                                $sql = "SELECT * from tbl_announcement_receiver where receiver_name=:stud_name_id and isRead=:isread";
                                $query = $dbh -> prepare($sql);
                                $query->bindParam(':stud_name_id',$stud_name_id,PDO::PARAM_STR);
                                $query->bindParam(':isread',$isread,PDO::PARAM_STR);
                                $query->execute();
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <?php 
                                    ...
                                    if($query->rowCount() > 0) {
                                        foreach($results as $result)
                                        { ?> 
                                <a class="dropdown-item d-flex align-items-center" href="announcement_details.php?ann_id=<?php echo htmlentities($result->id);?>">
                                    <div class="mr-3">
                                        <div class="icon-circle bg-success">
                                ...
                                <?php } ?>
                                <form action="announcement_history.php" method="POST" enctype="multipart/form-data">
                                <button style="outline: none;" class="dropdown-item text-center small text-gray-500" href="" name="read_all">Mark All as Read</button>
                                <input type="text" name="read_all_notifs" hidden="" value="read all">
                                </form>
                            </div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    ...
                                    <br><p><?php  include 'session.php'; echo $_SESSION['student_fname'];?></p>
                                </span>
                                <?php 
                                                                            
                                ?>
                                <img class="img-profile rounded-circle" src="../admin/uploaded_images/<?php session_start(); echo $_SESSION['student_image'];?>">
                                <!-- Image here -->
                            </a>
                              ...
                              <form class="" action="change_username_password_config.php" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                          ...
                                          function trigger(){
                                            if(input.value != ""){
                                              ...
                                              if(no==1){
                                                ...
                                                text.textContent = "Your password is too weak (minimum is 8 characters). Please contains symbols, number, and uppercase letter.";
                                                text.classList.add("weak");
                                              }
                                              if(no==2){
                                                medium.classList.add("active");
                                                text.textContent = "Your password is medium. Password must be atleast 8 characters. Please contains symbols, number, and uppercase letter.";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" style="color: #333333; background: white;" name="confirm_pword" class="form-control" id="confirm_pword" aria-describedby="" placeholder="Confirm Your New Password" required="">
