            ...
            <li class="nav-item active">
                ...
                <div id="collapseAnnouncements" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="announcements_history.php">All</a>
                    </div>
                </div>
            </li>
...
<!-- Page Heading -->
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><span><b>My Announcements</b> / All</span></h1>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <a href="announcements_history.php" class="btn btn-sm btn-primary shadow-sm active" title="Click Here To See All Your Announcements"><i class="fas fa-reply-all"></i> All</a>

            <a href="announcement_for_today.php" class="btn btn-sm btn-warning shadow-sm" title="Click Here To See The Your New Announcements for Today"><i class="fas fa-calendar-day"></i> Today</a>
        </div>
        <div class="card-header py-3" style="background: #595959;">
        <?php ?>
            <h6 class="m-0 font-weight-bold" style="color: ghostwhite;">
                <i class="fas fa-calendar"></i> All Announcements That I Posted
            </h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table" id="dataTable" width="100%"  cellspacing="10"  id="example" style="color:  #333333;">
                  ...
                  <?php
                    ...
                    $stats = "not archived";
                    $count = 1;
                    $sql = "SELECT * FROM tbl_announcement WHERE status='$stats' and posted_by='$_posted_by' ORDER BY id DESC";
                    $query = $conn->query($sql);
    ...
    if (isset($_SESSION['edited'])) {?>
        <script>
            swal.fire({
             icon: 'success',
             type : 'success',
             title : 'Announcement Was Edited',
             text : '<?php echo $_SESSION['edited']?>'
         })
        </script>
