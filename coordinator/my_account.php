      ...
      <form action="my_account_profile_pic_update.php" method="post" enctype="multipart/form-data">
          <div class="modal-body">
                ...
                <div class="form-group">
                    <input type="file" accept="image/png, image/gif, image/jpeg" style="border: solid 1px gray;" class="form-control" onchange="validateFileType()" id="my_profile_pic" name="my_profile_pic" required>
                </div>
          </div>
...
<!-- Page Heading -->
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body" style="color: #333333;">
            The use of this application is intended only to help the teachers in viewing and updating their information.<br><br>
            All fields marked with blue asterisk ( <span style="color: blue">*</span> ) are fields that unavailable for editing (such as Employee ID and Name). Changing these information can be done by Dean only.<br><br>
                        ...
                        <div class="col">
                          <form action="my_account_update.php" method="post" enctype="multipart/form-data"><!-- form started -->
                            <div class="form-group">
                                ...
                                <input type="text" name="acc_id" id="acc_id" class="form-control" id="acc_id" aria-describedby="" placeholder="" value="<?php echo "".$_SESSION['coordinator_id']; ?>" readonly="" onkeypress="return alpha(event)">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg">
                                <div class="form-group">
                                    ...
                                    <input type="email" onblur="checkAvailabilityMyEmail()" name="email" class="form-control" id="my_email" onkeypress="return event.charCode != 32" aria-describedby="" placeholder="ex. juandelacruz09@gmail.com" value="<?php echo "".$_SESSION['coordinator_email']; ?>" required="">
                            ...
                            <div class="col-lg">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" onkeypress="return alpha(event)" id="address" placeholder="ex. Brgy. Bubukal, Santa Cruz, Laguna" class="form-control" rows="12"><?php echo $_SESSION['coordinator_address']; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="password" name="pword" class="form-control" id="pword" aria-describedby="" placeholder="Enter Your Password" required="">
                                </div>
