        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion"  id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manage</h6>
                        <a class="collapse-item active" href="my_requirements_for_students.php">Today</a>
...
<!-- Page Heading -->
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><span><b>My Requirements</b> / Today </span></h1>
    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Instructions: </label> <span style="color: red">*</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Due Date: </label> <span style="color: red">*</span>
                                    <input type="date" id="duedate" name="duedate" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Upload Sample File:</label>
                                    <input type="file" name="sample_file" id="sample_file" class="form-control" id="sample_file" aria-describedby="" placeholder="">
                                </div>
                                <div class="form-group">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <a href="my_requirements_for_students_history.php" class="btn btn-sm btn-primary shadow-sm" title="Click Here To See All The Requirements You Provided"><i class="fas fa-reply-all"></i> All</a>

             <a href="my_requirements_for_students.php" class="btn btn-sm btn-warning shadow-sm active" title="Click Here To See All The Requirements You Provided for Today"><i class="fas fa-calendar-day"></i> Today</a>
        </div>
        <div class="card-header py-3" style="background: #595959;">
        <?php ?>
            <h6 class="m-0 font-weight-bold" style="color: ghostwhite;">
                <i class="fas fa-folder"></i> List of Distributed Requirement for My Students - Today, <?php date_default_timezone_set('Asia/Manila');
                $timestamp = time();
                $td = date("F d, Y"); echo $td; ?>
            </h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table" id="dataTable" width="100%" cellspacing="10"  id="example" style="color:  #262626;">
                  <thead>
                    <tr>
                      <th hidden="">ID</th>
                      <th>No.</th>
                  ...
                  <?php
                    ...
                    $stats = "not archived";
                    $count = 1;
                    $sql = "SELECT * FROM tbl_coordinator_save_works WHERE name_of_teacher='$my_fullname_' and date_='$td' and status='$stats' ORDER BY id ASC";
                    $query = $conn->query($sql);
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <hr>
                                                <div class="form-group">
                                                    <label>Upload New Example File</label>
...
?>
    ...
    <a class="scroll-to-top rounded" style="text-decoration: none;" href="#page-top">
        <i class="fas fa-ang"></i>
        <i class="fas fa-angle-up"></i>
        <i class="fas fa-angl"></i>
    </a>
