        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion"  id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseMyAnnouncements" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Category</i></h6>
                        <a class="collapse-item" href="my_announcement_for_today.php">Today</a>
                        <a class="collapse-item active" href="my_announcement_history.php">All</a>
                    </div>
                </div>
            </li>
...
<!-- Page Heading -->
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <a href="my_announcement_history.php" class="btn btn-sm btn-primary shadow-sm active" title="Click Here To See All Your Announcements"><i class="fas fa-reply-all"></i> All</a>
            <a href="my_announcement_for_today.php" class="btn btn-sm btn-warning shadow-sm" title="Click Here To See Your New Announcements for Today"><i class="fas fa-calendar-day"></i> Today</a>
        </div>
        <div class="card-header py-3">
        <?php ?>
            <h6 class="m-0 font-weight-bold" style="color: #333333">
                Announcements that I Posted - All
            </h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table" id="dataTable" width="100%"  cellspacing="10"  id="example" style="color:  #333333;">
                  ...
                  <?php
                    ...
                    $stats = "not archived";
                    $count = 1;
                    $sql = "SELECT * FROM tbl_announcement WHERE status='$stats' and posted_by='$_posted_by' ORDER BY id ASC";
